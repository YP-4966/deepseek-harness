// Rewriting reverse proxy for cloudflared origin: makes /api requests look
// loopback-originated to the dsh host so its browser-trust fence passes.
...
const server = http.createServer((req, res) => {
  const proxy = http.request(
    ...
    (upstreamRes) => {
      writeHead(res, upstreamRes.statusCode, upstreamRes.headers)
